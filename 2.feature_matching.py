...
#Function for Loading input image and Keypoints and return rey scal image
def load_input():
	input_image = cv2.imread('notebook.jpg')
...
#Function for Computing Matches between the train and query descriptors and return good matches
